...
export class AmazonService {
  ...
  getMobileModels(brand:any) {
    ...
    queryheaders = queryheaders.append('X-RapidAPI-Host', 'mobile-phone-specs-database.p.rapidapi.com');
  ...
  getMobileSpecifications( brand:any, model:any) {
    ...
    return this.http.get<any>(mobileSpecificationsUrl, {headers: queryheaders}).pipe(
      map((itemData: any): any => {
        return{
